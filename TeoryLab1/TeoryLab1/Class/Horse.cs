...
namespace TeoryLab1 {
    public class Horse {
        ...
        public const int intervalMove = 150;
        public Horse(Color color, int number, string name) {
            ...
            animationTimer.Interval = intervalMove; // 20 мс = 50 FPS 100 мс на 10 шагов.
        ...
        public const int animationSteps = 6; // Количество шагов анимации
        ...
        public void drawMovingHorse(Graphics g) {
            ...
            drawPixel(g, positionX + 12 * sizePixel, positionY + sizePixel * 7, color);
            drawPixel(g, positionX + 12 * sizePixel, positionY + sizePixel * 8, color);
            drawPixel(g, positionX + 11 * sizePixel, positionY + sizePixel * 8, color);

            drawPixel(g, positionX + 10 * sizePixel, positionY + sizePixel * 8, Color.Black);
            ...
            drawPixel(g, positionX + 14 * sizePixel, positionY + sizePixel * 7, color);

            drawPixel(g, positionX + 13 * sizePixel, positionY + sizePixel * 7, Color.Black);
            ...
            drawPixel(g, positionX + 25 * sizePixel, positionY + sizePixel * 6, color);
            drawPixel(g, positionX + 25 * sizePixel, positionY + sizePixel * 7, color);
            drawPixel(g, positionX + 24 * sizePixel, positionY + sizePixel * 7, color);
            drawPixel(g, positionX + 23 * sizePixel, positionY + sizePixel * 7, color);
            drawPixel(g, positionX + 22 * sizePixel, positionY + sizePixel * 7, Color.Black);

            ////четвертая
            drawPixel(g, positionX + 27 * sizePixel, positionY + sizePixel * 5, color);
            drawPixel(g, positionX + 27 * sizePixel, positionY + sizePixel * 6, color);
            drawPixel(g, positionX + 27 * sizePixel, positionY + sizePixel * 7, color);
            drawPixel(g, positionX + 27 * sizePixel, positionY + sizePixel * 8, color);
            drawPixel(g, positionX + 26 * sizePixel, positionY + sizePixel * 8, color);
            drawPixel(g, positionX + 25 * sizePixel, positionY + sizePixel * 9, Color.Black);
        ...
        public void drawBody(Graphics g) {
            ...
            using (SolidBrush brush = new SolidBrush(Color.Black)) {
                ...
                g.DrawString((number + 1).ToString(), font, brush, positionX + 55, positionY);
            }
        }
        ...
        public void StartAnimation(int newPosition) {
            startPositionX = positionX;
            targetPosition = newPosition * 35 + shiftX + 10;
            animationStep = 0;
        ...
        private void AnimationTimer_Tick(object sender, EventArgs e) {
            if (animationStep < animationSteps) {
                this.animationStep++;
                if (positionX < targetPosition) {
                    this.positionX = positionX + 7;
                }
        ...
        public void moving(int move, ref Horse[] horses, int horseIndex) {
            if (position + move >= Map.distance) {
                if (reach == false) {
                    ...
                    if (Form1.winnerHorse.Count >= 3 && horses.Length == 0) {
